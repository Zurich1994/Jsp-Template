...
<%
   ...
   boolean flag = false ;
    ...
    try
    {
       ...
       datetime = request.getParameter("new_datetime") ;
       money = request.getParameter("new_money") ;
    }
    catch(Exception e)
    {
    	e.printStackTrace();
...
<%
   // 更新note表中的数据
   String sql = "UPDATE rec set name=?,address=?,phone=?,datetime=?,money=? WHERE id=?" ;
   try
   {
